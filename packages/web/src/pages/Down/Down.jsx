    ...
    <div className={cx('root')}>
      <div className={cx('container')}>
        <div className={cx('left')}>
          ...
          <P className={cx('p')} latin>follow us on <a href="tg://resolve?domain=full_stacks" className={cx('link')}>@full_stacks</a></P>
          <a href="tg://join?invite=GQWIdljUMczeYI5bKc1VMw">
            <Button className={cx('button')}>
              <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" viewBox="0 0 512 512" className={cx('tg-icon')}>
